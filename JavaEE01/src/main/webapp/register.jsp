...
<div class="main">
    ...
    <form class="login-form" action="register" >
        ...
        <div class="input-content">
            ...
            <div>
                ...
                <input type="text" autocomplete="off"
                       ...
                       placeholder="用户姓名" name="name" required/>
        ...
        <div style="text-align: center">
            ...
            <button id="login_btn" class="enter-btn">注册</button>

        </div>

        <div class="foor">

            <div class="right"><span onclick="window.location.href='index.jsp'">返回</span></div>
